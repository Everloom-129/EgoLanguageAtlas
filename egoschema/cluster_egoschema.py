#!/usr/bin/env python3
"""STAGE 4 (embed + cluster) for EgoSchema.
...
artifacts. Exemplars carry full text: EgoSchema is CC BY-NC 4.0, which
...
HDBSCAN_PARAMS = dict(min_cluster_size=12, min_samples=4, metric="euclidean",
