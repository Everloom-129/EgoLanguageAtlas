...
| OpenEgo | dataset (unified corpus) | corpus, hand-pose, vla-pretrain | task-instruction, atomic-substep, verb-noun-action | n/a | n/a | not yet: Box folder needs auth, download script coming soon, no HuggingFace mirror | mixed per-source (MIT code; constituents vary, some CC BY-NC-ND) | [EN](openego/openego_atlas.html) / [CN](openego/openego_atlas_cn.html) (descriptive) |
