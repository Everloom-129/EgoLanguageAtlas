...
| EgoDex | dataset (corpus + benchmark) | corpus, hand-pose, vla-pretrain, eval-benchmark | task-instruction | n/a | n/a | open download (Apple CDN); redistribution barred | CC BY-NC-ND: annotation-text redistribution NOT permitted | [EN](egodex/egodex_atlas.html) / [CN](egodex/egodex_atlas_cn.html) (descriptive) |
...
| EgoSchema | benchmark | eval-benchmark | vqa | n/a | n/a | open questions + options; correct-answer key withheld | Ego4D License (questions LLM-generated then human-curated) | [EN](egoschema/egoschema_atlas.html) / [CN](egoschema/egoschema_atlas_cn.html) (descriptive) |
...
| EgoVLP (EgoClip / EgoNCE / EgoMCQ) | method + derived corpus | perception-pretrain, corpus, eval-benchmark | clip-narration, verb-noun-action | n/a | n/a | open CSV (Ego4D-derived) via repo Drive links | code MIT; data inherits Ego4D License | [EN](egovlp/egovlp_atlas.html) / [CN](egovlp/egovlp_atlas_cn.html) (descriptive) |
...
| HAT (Humanoid Policy ~ Human Policy) | method + corpus | co-train, corpus, hand-pose | task-instruction | n/a | n/a | open (MIT), but language lives inside HDF5 episode attributes | MIT (dataset) | [EN](ph2d/ph2d_atlas.html) / [CN](ph2d/ph2d_atlas_cn.html) (descriptive) |
