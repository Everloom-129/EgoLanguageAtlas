...
PLANNED = [
    ...
    {
        "category": "method", "name": "EgoScale", "venue": "arXiv 2026",
        "arxiv": "https://arxiv.org/abs/2602.16710",
        "usage_methods": ["vla-pretrain", "hand-pose"], "annotation_types": [],
        "source_datasets": "large-scale egocentric human video (~20,854 h, aggregated)",
        "data_access": "none", "downloadable": "none (model; code coming soon, no dataset)",
        "license": "not stated (code coming soon)",
        "suitability": "descriptive-only: VLA scaling-law study, releases a model not a corpus",
        "focus": "A dexterous-manipulation VLA pretrained on about 20,854 hours of action-labeled egocentric human video, showing a log-linear scaling law between human-data scale and prediction error.",
    },
]
