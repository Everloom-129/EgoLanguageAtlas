#!/usr/bin/env python3
"""STAGE 4 (embed + cluster) for HAT / PH2D.
...
artifacts. Exemplars carry full text: HAT / PH2D is CC BY-NC 4.0, which
...
UMAP_VIZ = dict(n_components=2, n_neighbors=8, min_dist=0.10, metric="cosine", random_state=42)
UMAP_CLU = dict(n_components=5, n_neighbors=8, min_dist=0.00, metric="cosine", random_state=42)
HDBSCAN_PARAMS = dict(min_cluster_size=2, min_samples=1, metric="euclidean",
